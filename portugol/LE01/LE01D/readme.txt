Lista de Exercícios 01 Questão D
...
LITROS_USADOS ← DISTANCIA / 12. Ao final, o programa deve apresentar os valores da distância percorrida (DISTANCIA) e a quantidade de litros (LITROS_USADOS) utilizada na viagem.